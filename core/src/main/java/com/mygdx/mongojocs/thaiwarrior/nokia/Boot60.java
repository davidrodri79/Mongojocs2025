...
import com.mygdx.mongojocs.thaiwarrior.genmidp.AudioMma;
 ...
 *  
 */
public class Boot60 extends MIDlet implements Runnable {
    ...
    public void startApp()  {
        try {
            ...
            game = new StdGame(new AudioMma()/* new NoAudio() */);
        ...
        while (!Game.finished && thread != null) {
            ...
            try {
                ...
                if (deltaTime < targetMillis
                        && !(Game.CHEATS && Cheats
                                .isCheatEnabled(Cheats.CHEAT_TURBO))) {
