...
class unit
{
   ...
   public unit() {}
	...
	public unit(Image i, int w, int h, int numf, int _offx, int _offy, byte[] _cor)
	{	
...
*/
	...
	public void blit(Graphics gr)
   {
      ...
      if (numframes != 0)
         Game.PutSprite(foo,  Game.offsetx+x,Game.offsety+y, ashape+((offy/height)*numframes), cor,3);
      else
      {   
