...
public class MIDletRunScreen implements Screen {
    ...
    LayoutConf layouts[] = {
            new LayoutConf(1f, true, new Rectangle(0f,0.5f,1f,0.5f), new Rectangle(0f,0.0f,1f,0.5f)),
    ...
    public void render(float delta) {
        ...
        Canvas.theCanvas.flushRepaints();
                ...
                launcher.batch.draw(Display.screenBuffer, px, 208*layouts[launcher.currentLayout].screen.y + py, Display.width, Display.height * layouts[launcher.currentLayout].screen.height, 0, 1, 1, 0);
                launcher.batch.end();
