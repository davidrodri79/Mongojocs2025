...
public Marco()
{
	Graphics.fontGenerate(Font.FACE_PROPORTIONAL, Font.STYLE_BOLD, Font.SIZE_SMALL, Color.WHITE);
...
public int MarcoRUN(int Key, int KeyY)
{
	...
	case 2:
		...
		if (KeyY==1) {MarTexScrY-=4;}

		if (KeyY!=-1 && --MarTexScrY < -TextoSizeY) {MarTexScrY++; Ret=-2;}
		}
	break;
