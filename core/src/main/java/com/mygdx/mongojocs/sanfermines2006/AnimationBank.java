...
/**
 * com.mygdx.mongojocs.sanfermines2006.AnimationBank representa un banco de animaciones, el cual contiene la
 * informaci�n de secuencias, fotogramas e im�gen.
 * 
 * @author Tony
 * 
 */
public final class AnimationBank implements AnimPakConstants {
    
    // cache de im�genes
    private static Hashtable BITMAP_CACHE = new Hashtable();
    private static Vector BANKS = new Vector();
...
//#endif
     ...
     */
    public static void releaseUnusedResources(AnimationBank ab) {
        ...
        for (int c = 0; c < ab.cellGroups; c++) {
        	for (int a = 0; a < BANKS.size(); a++) {        		
        		ab = (AnimationBank)BANKS.elementAt(a);
        	//#ifdef J2ME
	            String pngName = filename + "g" + c;

	            //#if DEBUG && DEBUG_ANIMATOR
		        	Debug.println("Comprobando si a�n est� en uso: " + pngName);
	        	//#endif            

	            if (noMoreBanks || !isAnimationBankUsingBitmap(ab,pngName))
	            {
            	//#if DEBUG && DEBUG_ANIMATOR
	            	Debug.println("Liberando recursos gr�ficos: " + pngName);
            	//#endif
            ...
            //#elifdef DOJA
                ...
                //#if DEBUG && DEBUG_ANIMATOR
	            	com.mygdx.mongojocs.sanfermines2006.Debug.println("Comprobando si a�n est� en uso: " + gifName);
            	//#endif            
	                if (noMoreBanks || !isAnimationBankUsingBitmap(ab,gifName)) {
                	//#if DEBUG && DEBUG_ANIMATOR
	                	com.mygdx.mongojocs.sanfermines2006.Debug.println("Liberando recursos gr�ficos: " + gifName);
	               	//#endif
     ...
     */
    public static boolean isAnimationBankUsingBitmap(AnimationBank ab, String filename) {    	
